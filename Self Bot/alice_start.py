...
@death.event
async def on_ready():
    ctypes.windll.kernel32.SetConsoleTitleW(f'Death | Logged in as {death.user} | Guild Count {len(death.guilds)}')
    channel = death.get_channel(1082327491366109314)
    await channel.send(f"```yaml\n[Welcome, {death.user} to Death Self Bot]\nYour prefix is: {prefix}\nUse: {prefix}help to get started!```", delete_after=5)
    clear()
...
""")
    ...
    print(Fore.LIGHTRED_EX + """└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘""")
    print(Fore.LIGHTRED_EX + f"ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤLogged in as |", Fore.RED + f"{death.user}")
    print(Fore.LIGHTRED_EX + f"ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤUser ID |", Fore.RED + f"{death.user.id}")
    print(Fore.LIGHTRED_EX + f"ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤPrefix |", Fore.RED + f"{prefix}")
    print(Fore.LIGHTRED_EX + f"ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤVersion |", Fore.RED + f"{version}")
    print(Fore.LIGHTRED_EX + f"ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤGuild Count |", Fore.RED + f"{len(death.guilds)}")
    print(Fore.LIGHTRED_EX + f"ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤStatus |", Fore.GREEN + "Authenticated")
    print(Fore.LIGHTRED_EX + f"ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤNitro Sniper |", Fore.RED + f"{Fore.GREEN}{snipe_status}")
    print(Fore.LIGHTRED_EX + f"ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤPing Detector |", Fore.RED + f"{Fore.GREEN}{ping_status}")
...
async def slap(ctx, user: discord.User):
     ...
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "slap", Fore.LIGHTRED_EX + "<<")
...
async def kiss(ctx, user: discord.User):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "kiss", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     ...
     print(Fore.LIGHTRED_EX + "                                                      >>", Fore.RED + "kiss", Fore.LIGHTRED_EX + "<<")

@death.command()
async def hug(ctx, user: discord.User):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "hug", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     ...
     print(Fore.LIGHTRED_EX + "                                                    >>", Fore.RED + "hug", Fore.LIGHTRED_EX + "<<")

@death.command()
async def spam(ctx, amount: int, *, message):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "spam", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def ascii(ctx, *, text):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "ascii", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def iplookup(ctx, ipaddress = None):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "iplookup", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     if ipaddress is None:
          await ctx.send(f"```yaml\n[ERROR] [Death Self Bot]\nInvalid Syntax! use {prefix}ipaddress [IP HERE]```", delete_after=3)
     else:
          p = requests.post('http://ip-api.com/json/' + ipaddress)
          if '"status":"success"' in p.text:
               await ctx.send(f"```yaml\n[Death Self Bot]\nHost: {ipaddress}\nCountry: {p.json()['countryCode']}\nRegion: {p.json()['region']}\nRegion Name: {p.json()['regionName']}\nCity: {p.json()['city']}\nTimezone: {p.json()['city']}\nZip: {p.json()['zip']}\nISP: {p.json()['isp']}```", delete_after= 5)
                        
@death.command()
async def servericon(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "servericon", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def tableflip(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "tableflip", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     tableflip = '(╯°□°）╯︵ ┻━┻'
...
async def shrug(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "shrug", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     shrug = r'¯\_(ツ)_/¯'
     await ctx.send(shrug)
     print(Fore.LIGHTRED_EX + "                                                    >>", Fore.RED + "shrug", Fore.LIGHTRED_EX + "<<")

@death.command()
async def lenny(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "lenny", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     lenny = '( ͡° ͜ʖ ͡°)'
     await ctx.send(lenny)
     print(Fore.LIGHTRED_EX + "                                                    >>", Fore.RED + "lenny", Fore.LIGHTRED_EX + "<<")

@death.command()
async def sniper(ctx, user: discord.User = None):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "sniper", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     sniper = "https://i.imgur.com/ey46gL5.gif"
     await ctx.send(f"> ```{user} Has been sniped```\n")
     await ctx.send(sniper)
     print(Fore.LIGHTRED_EX + "                                                    >>", Fore.RED + "sniper", Fore.LIGHTRED_EX + "<<")
...
async def fakenitro(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "fakenitro", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def rickroll(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "rickroll", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def a1337(ctx, *, text):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "leetspeech", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def _ball(ctx, *, question):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "Death Ball Has Spoken", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def userbanner(ctx, user: discord.Member=None):
     ...
     if user == None:
          user = ctx.author
     req = await death.http.request(discord.http.Route("GET", "/users/{uid}", uid=user.id))
     ...
     if banner_id:
          ...
          await ctx.message.delete()
          print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "userbanner", Fore.LIGHTRED_EX + "<<")
     else:
          return
...
async def guildban(ctx, member : discord.User=None):
     if member is None:
          await ctx.send("```yaml\n[ERROR] [Death Self Bot]\nPlease specify a user and reason.```", delete_after = 3)
     else:
          try:
...
async def watching(ctx, *, message):
     await ctx.message.delete()
     await death.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name=message))
...
async def rolehex(ctx, *, role: discord.Role):
     await ctx.message.delete()
     await ctx.send(f"```yaml\n[Death Self Bot] - [Role Color]\nRole: {role.name}\nColor: {role.color}```", delete_after=4)
...
async def setbanner(ctx, *, url):
     ...
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "setbanner", Fore.LIGHTRED_EX + "<<")
...
async def setpfp(ctx, *, url):
     ...
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "setpfp", Fore.LIGHTRED_EX + "<<")
     if config.get('password') == 'password-here':
          await ctx.send("Put the password in config.json")
     else:
          password = config.get('password')
...
async def masschannel(ctx, arg):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "masschannel", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     for _i in range(450):
          try:
...
async def poll(ctx, *, arguments):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "poll", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def pfpsteal(ctx, user: discord.Member):
     ...
     if config.get('password') == 'password-here':
          ...
          print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "pfpsteal", Fore.LIGHTRED_EX + "<<")
...
def Dump(ctx):
     try:
          now = datetime.now()
          current_time = now.strftime("%H:%M:%S")
          print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "stealall", Fore.LIGHTRED_EX + "<<")
          for member in ctx.guild.members:
          ...
          now = datetime.now()
          current_time = now.strftime("%H:%M:%S")
          print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + f"Dumped to {ctx.guild.name}--Dump.txt", Fore.LIGHTRED_EX + "<<")
...
async def hypesquad(ctx, house = None):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "hypesquad", Fore.LIGHTRED_EX + "<<")
     global payload
     await ctx.message.delete()
     if house is None:
          ...
          try:
            ...
            await ctx.send(f"```yaml\n[Death Self Bot]\nHypesquad House Changed to {house}```", delete_after=2)
...
async def changetoken(ctx, *, txt):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "changetoken", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def changeprefix(ctx, *, txt):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "changeprefix", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     with open('config/config.json') as con:
          configs = json.load(con)
          configs['prefix'] = txt
          ...
          global prefix
          prefix = txt
          await ctx.send(f"```yaml\n[Death Self Bot]\nPrefix changed to: {txt}```", delete_after=3)

@death.command()
async def rudy(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "Disguised as RudyThePinkRug", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     if config.get('password') == "password-here":
...
async def alice(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "alice", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     if config.get('password') == "password-here":
          await ctx.send(f"Put password in config")
...
async def ghost(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "ghost", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     if config.get('password') == "password-here":
          await ctx.send(f"Put password in config")
...
async def purge(ctx, amount: int):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "purge", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def restart(ctx):
  now = datetime.now()
  current_time = now.strftime("%H:%M:%S")
  print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "restart", Fore.LIGHTRED_EX + "<<")
  await ctx.message.delete()
  ...
  await message.edit(content="```yaml\n[Death Self Bot]\nRestarted successfully.```", delete_after=2)
...
async def ghostping(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "ghostpinged", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def channelcrash(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "channelcrash", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     try:
          ...
          print(Fore.LIGHTRED_EX + "                                                    >>", Fore.RED + "channelcrasher", Fore.LIGHTRED_EX + "<<")
          return
     ...
     if 'discord.gift/' in message.content:
          if nitro_sniper == True:
               ...
               if 'This gift has been redeemed already.' in r:
                    print(Fore.LIGHTRED_EX + f"\n[{time}]", Fore.RED +  "- [Nitro Already Redeemed]")
                    ...
                    print(Fore.LIGHTRED_EX + f"\n[{time}]", Fore.RED + "- [Nitro Unknown Gift Code]")
                    NitroData(elapsed, code)
...
async def slots(ctx):
     ...
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "slots", Fore.LIGHTRED_EX + "<<")
     emojis = "🍎🍊🍐🍋🍉🍇🍓🍒"
...
async def pingweb(ctx, website=None):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "pingweb", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     if website is None:
          error = await ctx.send(f"```yaml\n[ERROR] [Death Self Bot] - You forgot to put a website```", delete_after = 3)
          await asyncio.sleep(2)
          await error.delete()
     else:
          try:
          ...
          if r == 404:
               await ctx.send(f"```yaml\n[ERROR] [Death Self Bot] - Website is down {r}```", delete_after = 3)
          else:
               await ctx.send(f"```yaml\n[Death Self Bot] - Website is online {r}```", delete_after = 3)
...
async def nine_eleven(ctx):
   now = datetime.now()
   current_time = now.strftime("%H:%M:%S")
   print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "911", Fore.LIGHTRED_EX + "<<")
   await ctx.message.delete()
   invis = ""
...
async def cum(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "cum", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def count(ctx):
     ...
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "count", Fore.LIGHTRED_EX + "<<")
     await asyncio.sleep(2)
     for _ in range(100):
...
async def abc(ctx):
     ...
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "abc", Fore.LIGHTRED_EX + "<<")
...
async def _100(ctx):
     ...
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "editing count to 100", Fore.LIGHTRED_EX + "<<")
...
async def reav(ctx, user: discord.User=None):
     ...
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "reav", Fore.LIGHTRED_EX + "<<")
     if user == None:
          user = death.user
     try:
          await ctx.send(f"https://images.google.com/searchbyimage?image_url={user.avatar.url}")
     except:
...
async def userinfo(ctx, wondermember: discord.User=None):
    ...
    now = datetime.now()
    current_time = now.strftime("%H:%M:%S")
    print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "userinfo", Fore.LIGHTRED_EX + "<<")
...
async def ping(ctx):
    now = datetime.now()
    current_time = now.strftime("%H:%M:%S")
    print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "ping", Fore.LIGHTRED_EX + "<<")
    await ctx.send("Pong!")
...
async def avatar(ctx, avamember: discord.Member = None):
        now = datetime.now()
        current_time = now.strftime("%H:%M:%S")
        print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "avatar", Fore.LIGHTRED_EX + "<<")
        await ctx.message.delete()
        if avamember == None:
...
async def playing(ctx, *, start):
        ...
        now = datetime.now()
        current_time = now.strftime("%H:%M:%S")
        print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "playing", Fore.LIGHTRED_EX + "<<")
...
async def serverinfo(ctx):
        now = datetime.now()
        current_time = now.strftime("%H:%M:%S")
        print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "serverinfo", Fore.LIGHTRED_EX + "<<")
        await ctx.message.delete()
...
async def newwebhook(ctx, *, name):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + f"webhook created {name}", Fore.LIGHTRED_EX + "<<")
...
async def spamwebhook(ctx, amount: int, url, *, message = None):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "spamwebhook", Fore.LIGHTRED_EX + "<<")
...
async def tokeninfo(ctx, tokeninfotoken = None):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "tokeninfo", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
         ...
         await ctx.send(f'You have not specified a token.')
          ...
          try:
               ...
               if r.status_code == 200:
                    ...
                    await ctx.send(f'> ```TOKEN INFORMATION```\n```USER ID: {userID}\nUSERNAME: {userName}\n2FA?: {mfa}\nEMAIL: {email} \nPHONENUMBER?: {phone}\nTOKEN:{tokeninfotoken}```')
          except Exception as error:
...
async def deathchannel(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "deathchannel", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def deathdestroy(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "deathdestroy", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     ...
     try:
          with open(("./config/Images/banner.gif"), "rb") as bannermf:
               ...
               await ctx.guild.edit(name=f"FUCKED BY {ctx.author}", description="DEATH LMAO", reason="DEATH LMAO", banner=banner)
     except:
          pass
     for _i in range(100):
          await ctx.guild.create_text_channel(name="DEATH SELF BOT🔪")
...
async def massban(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "massban", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def masskick(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "masskick", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     users = list(ctx.guild.members)
     for user in users:
          try:
...
async def massunban(ctx):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "massunban", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def servername(ctx, *, name):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "serverrename", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
...
async def nickall(ctx, nickname):
     now = datetime.now()
     current_time = now.strftime("%H:%M:%S")
     print(Fore.LIGHTRED_EX + f"{current_time}", ">>", Fore.RED + "nickall", Fore.LIGHTRED_EX + "<<")
     await ctx.message.delete()
     for user in list(ctx.guild.members):
          try:
               await user.edit(nick=nickname)
